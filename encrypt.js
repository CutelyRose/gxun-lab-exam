...
!function(e) {
    ...
    t.oe = function(e) {
        ...
        function c(e, t) {
            var n = new i;
            n.digits[0] = t;
            for (var a = C(e, n), r = J[a[1].digits[0]]; 1 == k(a[0], q); )
                a = C(a[0], n),
                digit = a[1].digits[0],
                r += J[a[1].digits[0]];
            return (e.isNeg ? "-" : "") + s(r)
...
// u=window.jzq(45)
// u.a(131)
// var E = u.b(a.public_exponent, "", a.modulus);
// v = u.c(E, '123456')
...
// console.log(encrypt_pwd('123456'))

function get_loginUserToken(){
    u=window.jzq(45)
    u.a(131)
    var E = u.b(a.public_exponent, "", a.modulus);
   r = (new Date).getTime()
...
// console.log(get_loginUserToken())
